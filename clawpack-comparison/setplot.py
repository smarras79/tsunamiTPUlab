...
#--------------------------
    ...
    def fixup(current_data):
        ...
        t = current_data.t
        t = t / 3600.  # hours
        pylab.title('Surface at %4.2f seconds' % current_data.t, fontsize=20)
        pylab.xticks(fontsize=10)
        pylab.yticks(fontsize=10)
    plotaxes.afteraxes = fixup

    def surf_or_depth(current_data):
        drytol = 1e-1
        q = current_data.q
        h = q[0,:,:]
        eta = q[3,:,:]
    ...
    plotitem.plot_var = surf_or_depth
    plotitem.pcolor_cmin = -10
    plotitem.pcolor_cmax = 20
    plotitem.pcolor_cmap = pylab.get_cmap('Blues')
    ...
    # Land
    plotitem = plotaxes.new_plotitem(plot_type='2d_pcolor')
    plotitem.plot_var = land_method
    plotitem.pcolor_cmap = pylab.get_cmap('terrain')#geoplot.land_colors
    plotitem.pcolor_cmin = -10.0
    plotitem.pcolor_cmax = 40.0
    plotitem.add_colorbar = False
    #plotitem.amr_celledges_show = [1,1,0]
    #plotitem.patchedges_show = 1
    plotaxes.xlimits = [10000,15185]
    plotaxes.ylimits = [0,7200]
    ...
    plotdata.print_framenos = [10,18,26,34,38,40]          # list of frames to print
