...
#------------------------------
    ...
    clawdata.upper[0] = 15932.0

    clawdata.lower[1] = 0.0
    clawdata.upper[1] = 7204.0



    # Number of grid cells: Coarsest grid
    clawdata.num_cells[0] = int(1992)
    clawdata.num_cells[1] = int(901)
    ...
    regions.append([1, 1, 0., 1.e9, 0,16000,0,7400])
    regions.append([1, 3, 0., 1.e9, 7000,14500,0,7200])
...
#-------------------
    ...
    #    [topotype, fname]
    topo_data.topofiles.append([2, 'crescent_city_harbor_rotated_upres.topo2'])
    ...
    rundata.qinit_data.qinitfiles = [[1, 3, 'crescent_city_ic.xyz']]
